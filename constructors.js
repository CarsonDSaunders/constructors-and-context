...
User.prototype.removeSavedPost = function (postId) {
  let postRemoveId = this.savedPosts.findIndex(post => {
    return post.id === postId
  });
  console.log(postRemoveId)
  this.savedPosts.splice(postRemoveId, 1);
...
User.prototype.changePostRating = function (postId, newRating) {
  let postChangeId = this.savedPosts.findIndex(post => post.id === postId);
  this.savedPosts[postChangeId].rating = newRating;
}